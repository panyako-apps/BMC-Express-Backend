...
export const getFlatCategories = (req, res) => {

    const sqlQuery = "SELECT * FROM flat_categories"
...
export const addFlatCategory = (req, res) => {

    const sqlQuery = "INSERT INTO flat_categories (`id`, `name`) VALUES(?)";
...
export const getFlatCategory = (req, res) => {

    const sqlQuery = "SELECT * FROM flat_categories WHERE `id`=?"
...
export const updateFlatCategory = (req, res) => {
    ...
    jwt.verify(token, "jwt-secret-key", (err, userInfo)=>{
        ...
        const sqlQuery = "UPDATE flat_categories SET `first_name`=?, `other_names`=? WHERE `id`=?";
...
export const deleteFlatCategory = (req, res) => {
    ...
    jwt.verify(token, "jwt-secret-key", (err, userInfo)=>{
        ...
        const buildingManagerId = req.params.id;
        const sqlQuery = "DELETE FROM flat_categories WHERE `id`=?";
